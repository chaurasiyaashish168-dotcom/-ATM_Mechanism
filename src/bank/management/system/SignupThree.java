...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree( String formno){
     ...
     this.formno= formno;
        ...
        r1.setBounds(100,180,190,30);
        add(r1);
        
        r2= new JRadioButton(" Fixed Deposit  Account");
        r2.setFont(new Font ("Raleway",Font.BOLD,16));
        r2.setBackground(Color.WHITE);
        r2.setBounds(350,180,290,30);
        add(r2);
        r3 = new JRadioButton("Current  Account");
        r3.setFont(new Font ("Raleway",Font.BOLD,16));
        r3.setBackground(Color.WHITE);
        r3.setBounds(100,220,190,30);
        add(r3);
        ...
        add(pnumber);
         ...
         JLabel pindetail=new JLabel ("Your 4 Digit Passwrd");
        ...
        services.setBounds(100,450,290,30);
        add(services);
        ...
        add(c6);
          ...
          c7= new JCheckBox("I hereby declare that the above entered details are correct to the best of my end");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway",Font.BOLD,10));
        c7.setBounds(100,700,500,30);
        add(c7);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            if(r1.isSelected()){
                ...
                accountType= "Fixed Depsit Account";
